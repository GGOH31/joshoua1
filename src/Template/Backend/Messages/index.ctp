    ...
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('lu') ?></th>
                <th scope="col"><?= $this->Paginator->sort('vu') ?></th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= h($message->objet) ?></td>
                <td><?= $this->Number->format($message->lu) ?></td>
                <td><?= $this->Number->format($message->vu) ?></td>
